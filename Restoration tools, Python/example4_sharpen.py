...
def example4_sharpen (imgChannel=None):
    ...
    imgChannel0 = rip.apply_channel_sharpen (0.01, imgChannel)
    imgChannel1 = rip.apply_channel_sharpen (1, imgChannel)
    imgChannel2 = rip.apply_channel_sharpen (3, imgChannel)
...
if __name__ == "__main__":
    ...
    # example 4- Sharpen
    res31, res32, res33 = example4_sharpen ()
    res34, res35, res36 = example4_sharpen_explicit()
    im4 = np.hstack((res31, res32, res33 ))
    iv4 = np.hstack((res34, res35, res36 ))
    im4 = np.vstack((im4,iv4))
    display ('Example 4 - gamma correction images', im4)   
    cv2.imwrite('example4.png', im4)
    cv2.imwrite('sharpen_output_1.png', res32)
    cv2.imwrite('sharpen_output_2.png', res33)
